...
<head>
    ...
    <title><?= $titre ?? 'Mobile Money Telma' ?></title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="<?= base_url('client') ?>">MobileMoney Telma</a>
        ...
        <div class="collapse navbar-collapse" id="navbarClient">
            <div class="ms-auto">
                <?php if (session()->get('client_id')): ?>
                    <span class="navbar-text me-3"><?= esc(session()->get('client_nom_utilisateur')) ?> (<?= esc(session()->get('client_telephone')) ?>)</span>
